...
# general triggers #
####################
async def initialize(data : Templates.Initialize):
    print('[Async example] initialize:', data)

async def toggle(data : Templates.Toggle):
    print('[Async example] toggle:', data)

async def newSettings(data : Templates.Settings):
    print('[Async example] newSettings:', data)

async def tick(data : Templates.Tick):
    print('[Async example] tick:', data)

async def webhook(webhook : Templates.Webhook):
    print('[Async example] webhook:', webhook)
